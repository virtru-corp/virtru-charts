...
| `keycloak.image.tag`                 | Keycloak Image Tag                                                                                                                             | `21.1.2-1.4.2`                                                                 |
...
| `trustedCertSecret`                  | Name of an existing secret containing certs to be added to the keycloak truststore. (keycloak prefix is used since its part of an include tpl) | `nil`                                                                          |
